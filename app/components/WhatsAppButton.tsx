...
export default function WhatsAppButton() {
  // নিচের নম্বরের জায়গায় আপনার হোয়াটসঅ্যাপ নম্বর দিন (দেশের কোডসহ)
  const phoneNumber = "8801753564808"; 
  const message = "হ্যালো Trendify BD! আমি একটি প্রোডাক্ট সম্পর্কে জানতে চাই।";
